    ...
    <div className="min-h-screen bg-[#050505] pb-24 text-white font-sans selection:bg-brand-pink/30">
      ...
      <div className="max-w-7xl mx-auto px-0 md:px-6 py-6 space-y-8">
        ...
        <div className="px-4 border-b border-white/10 pb-6">
            <div className="flex items-center gap-3 mb-3">
                ...
                <span className="text-[10px] font-mono text-brand-pink uppercase tracking-[0.2em] animate-pulse">
                    Stream Online // v.TharkiBeta.69
                </span>
            </div>
            
            <h1 className="text-5xl md:text-7xl font-black italic tracking-tighter leading-none mb-2">
                चलचित्र <span className="text-lg md:text-2xl font-mono not-italic text-transparent bg-clip-text bg-gradient-to-r from-brand-pink to-brand-purple tracking-normal ml-2 opacity-80">
                    // ONLYMOMSON
                </span>
            </h1>
            ...
            <div className="flex flex-wrap items-center gap-4 text-xs text-gray-500 font-mono mt-4 bg-[#0a0a0a] p-3 rounded-lg border border-white/5 inline-flex shadow-inner">
                <div className="flex items-center gap-2">
                    ...
                    <span>Cache: ONLYMOMSON_Clips</span>
                </div>
        ...
        <div className="px-4">
            ...
            {/* Masonry Layout - Matched to Image Page Smoothness */}
            <div className="columns-2 md:columns-3 lg:columns-4 gap-4 space-y-4">
              {posts.length > 0 ? (
                posts.map((post, index) => (
                    ...
                    >
                        {/* UPDATED: Removed 'bg-[#0a0a0a]', 'flex-col', 'leading-none' 
                           to match the cleaner Image Page structure.
                        */}
                ...
                <div className="col-span-full py-20 text-center border border-dashed border-white/10 rounded-2xl bg-[#0a0a0a]">
                    ...
                    <p className="text-gray-500 font-mono text-sm mb-2">/usr/bin/video: Signal Lost</p>
                    <p className="text-xs text-gray-700">Check connection or initiate re-scan.</p>
                </div>
              )}
            </div>
        </div>
                ...
                >
                    {loadingMore ? (
                        <>
                            ...
                            <span className="text-xs font-bold uppercase tracking-widest text-brand-pink">Buffering Next Segment...</span>
                        </>
                    ) : (
                        <>
        ...
        <div className="px-4">
            <AdSlot id="VIDEOS-BOTTOM-BANNER" type="banner" />
        </div>
