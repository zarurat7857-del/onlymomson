      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8 py-6">
        ...
        <div className="flex items-center justify-between mb-6">
            ...
            {/* <button 
                onClick={handleSync}
                disabled={syncing}
                className="flex items-center gap-2 px-4 py-2 bg-white/5 hover:bg-brand-purple/20 border border-white/10 rounded-full text-xs font-bold uppercase transition-all group"
            >
                <RefreshCw size={14} className={`text-gray-400 group-hover:text-white ${syncing ? "animate-spin text-brand-purple" : ""}`} />
                <span className={syncing ? "text-brand-purple" : "text-gray-400 group-hover:text-white"}>
